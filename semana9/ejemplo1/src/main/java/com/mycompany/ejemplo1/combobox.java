...
public class combobox extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        combo.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "rojo", "amarillo", "azul", "celeste" }));
    ...
    private void comboActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_comboActionPerformed
        ...
        String color="El color seleccionado es: ";
        color=color+combo.getSelectedItem().toString();
        txtlabel.setText(color);
